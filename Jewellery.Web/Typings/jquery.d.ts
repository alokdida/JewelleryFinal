...
interface JQueryStatic {
	...
	/**
     * datePicker control from JQuery UI.
     */
...
interface JQuery {
    ...
    */
	...
	/**
     * datePicker control from JQuery UI.
	 *@param method : method name to be invokes
	 *@param args : argument for the method
     */
	datepicker(method: any, args: any): Datepicker;

	/**
     * datePicker control from JQuery UI.
	 *@param options : modifying options
	 *@param optionToModify : datepicker option which needs to be modified.
	 *@param value: valued for the option 
     */
	datepicker(options: string, optionToModify: string, value: any): Datepicker;
}
...
interface Datepicker extends JQuery {
     ...
     * Manipulate the queue of functions to be executed, once for each matched element.
     * 
     * @param format: format of the Date you want to convert to.
     * @param date: Date object
	 * @param options: Options that can be passed
     */
    formatDate(format: string, date: Date, options: any): string;

	/**
     * Internal JQuery UI datepicker _getInst API
     * 
     * @param eventObj: JQuery Event object
     */
	_getInst(eventObj: Element): DatePickerInstanceObject;

	/**
     * Internal JQuery UI datepicker _adjustDate API
     * 
     * @param eventObj: JQuery Event object
	 * @param offset: Date offset 
	 * @param eventObj: Period for "M", "D", "Y"
     */
	_adjustDate(target: EventTarget, offset: number, period: string): DatePickerInstanceObject;
}

interface DatePickerInstanceObject {
	selectedYear: number;
