...
declare namespace Sdk {
	...
	class Collection<T>
	{
		 ...
		 */
		constructor(type: any, items?: Array<T>);
	...
	class Async {
		static create(entity: Entity, successCallBack: Function, errorCallBack: Function): void;
		static update(entity: Entity, successCallBack: Function, errorCallBack: Function): void;
		static del(entityLogicalName: string, recordId: string, successCallBack: Function, errorCallBack: Function): void;
		static execute(request: OrganizationRequest, successCallBack: Function, errorCallBack: Function, passThruObj?: any): void;
		static retrieve(entity: string, recordId: string, columSet: Sdk.ColumnSet, successCallBack: Function, errorCallBack: Function): void;
	}

	class AddEditModuleRequest extends OrganizationRequest {
		constructor(appModuleEntity: Entity, appComponents: EntityCollection, isNew: boolean);
	}
...
declare namespace Sdk.Util {
	...
	/**
	 * Creates an entitycollection from XML.
	 * @param The serialized entity returned from the SOAP service as XML.
	 */
	function createEntityCollectionFromNode(node: Node): Sdk.EntityCollection;
}

declare namespace Sdk.Xml {
	function selectSingleNode(xml: XMLDocument, path: string): Node;
	function isNodeNull(valueNode: Node): boolean;
}
...
declare namespace Sdk.Mdq {
	...
	export type AssociatedMenuBehavior = any;

	export type AssociatedMenuGroup = any;

	export type RelationshipType = any;

	export type SecurityType = any;
